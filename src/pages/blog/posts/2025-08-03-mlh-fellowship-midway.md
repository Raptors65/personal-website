...
As part of the fellowship, I've deployed a Flask portfolio site to a CentOS-based VPS hosted on DigitalOcean, connecting it to a MySQL database to store posts and containerizing it using Docker. In addition, I've written unit tests for it and added Nginx as a reverse proxy to handle SSL termination.

A huge thanks to [Major League Hacking](https://mlh.io/) for this opportunity! Looking forward to the next 6 weeks :)
